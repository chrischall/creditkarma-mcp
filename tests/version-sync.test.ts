...
//
// The walk + assertion is the fleet-shared `versionSyncTest` from
// @chrischall/mcp-utils/test; this file just points it at our src/ and
// package.json. If a future contributor registers a new version-bearing
// constant, add the `x-release-please-version` comment to the line and the
// helper starts asserting it automatically.
