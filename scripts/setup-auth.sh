...
# creditkarma.com, captures the full Cookie header (including the CKAT
# cookie that holds the access + refresh JWTs), and either prints it or
# writes it to an env file you pass.
#
